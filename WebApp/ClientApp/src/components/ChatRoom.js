...
import { ChatRoomCss } from "./css";

export class ChatRoom extends React.Component {
  constructor(props) {
    super(props);

    this.waitforconnect = this.waitforconnect.bind(this);
    ...
    this.vm = dotnetify.react.connect('ChatRoomVM$' + props.InstanceId, this);
  ...
  componentDidMount() {
    ...
    setTimeout(this.waitforconnect, 250);
    this.scrollToBottom();
  }
